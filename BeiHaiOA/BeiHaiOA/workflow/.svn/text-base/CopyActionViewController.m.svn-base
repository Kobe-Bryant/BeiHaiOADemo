...
- (void)viewDidLoad
{
    ...
    self.deptsArray = [self.usersHelper queryAllSubDept:@"050001"];//获得全部部门
...
{
    CGFloat headerHeight = 60.0;//05000113004
    ...
    NSArray *ary = [self.usersHelper queryAllUsersWithSub:bmbh];
